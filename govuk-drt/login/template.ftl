<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true>
    ...
    <head>
        ...
        <!--[if gt IE 8]><!-->
        <link href="${url.resourcesPath}/vendor/govuk_template/stylesheets/govuk-template.css?0.22.1" media="screen"
        ...
        <link href="${url.resourcesPath}/vendor/govuk_template/stylesheets/govuk-template-print.css?0.22.1"
        ...
        <!--[if gte IE 9]><!-->
        <link href="${url.resourcesPath}/vendor/govuk_template/stylesheets/fonts.css?0.22.1" media="all"
              rel="stylesheet"/><!--<![endif]-->
        ...
        <link rel="apple-touch-icon-precomposed" sizes="120x120"
              href="${url.resourcesPath}/vendor/govuk_template/images/apple-touch-icon-120x120.png?0.22.1">
        <link rel="apple-touch-icon-precomposed" sizes="76x76"
              href="${url.resourcesPath}/vendor/govuk_template/images/apple-touch-icon-76x76.png?0.22.1">
        <link rel="apple-touch-icon-precomposed"
              href="${url.resourcesPath}/vendor/govuk_template/images/apple-touch-icon-60x60.png?0.22.1">

        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta property="og:image"
              content="${url.resourcesPath}/vendor/govuk_template/images/opengraph-image.png?0.22.1">
                                        ...
                                        <div class="error-summary" role="group"
                                            ...
                                            <ul class="error-summary-list" id="error-details">
                                                ...
                                                <li>If you don't have an account for <#if login.username??>
                                                        ${login.username}</#if> username in DRT then please contact drtpoiseteam@homeoffice.gov.uk.</li>
                                            </ul>
                                        </div>
                                    <#else>
            ...
            <div class="footer-meta">
                <div class="footer-meta-inner">
                    <div class="drt-footer">
                        Data in this service is marked as OFFICIAL-SENSITIVE. It is not to be disseminated.
                    </div>
                </div>
            </div>
        </div>
