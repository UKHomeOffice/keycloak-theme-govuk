        ...
        <#if realm.password>
            <details>
                ...
                <div id="kc-form-wrapper" class="panel panel-border-narrow">
                    <form id="kc-form-login" class="${properties.kcFormClass!}" action="${url.loginAction}"
                          method="post">
                        ...
                        <div id="kc-form-buttons"
                             class="${properties.kcFormButtonsClass!} ${properties.kcFormGroupClass}">
                ...
                <ul class="list horizontal">
                    <#list social.providers as p>
                        <li><a href="${p.loginUrl}" id="zocial-${p.alias}"
                               class="button zocial ${p.providerId}">${p.displayName}</a></li>
                    </#list>
                </ul>
            </div>
        </#if>
