		...
		<div class="footer-meta">
			<div class="footer-meta-inner">
				...
				<div class="open-government-licence">
					...
					<p>Data retrieved from this application is not to be used for any purpose or by any party not specified on the applicable licence agreement.
					Any processing of or use of data that is not agreed within the terms and conditions of this licence must be prior referred to HM Passport Office.
					Any dissemination or use of data by any party other than the licence holder must be prior referred to HM Passport Office.</p>
				</div>
			</div>
